...
<Steps>
 <Step title="Criação de Request" stepNumber="1">
   ...
   Exemplo de consulta por documento em nossa base de dados:
   ...
   curl --request POST
    ...
    Exemplo de consulta por documento diretamente no tribunal:
    ...
    <Note>
     ...
     Abaixo, apresentamos um exemplo de resposta para uma busca realizada em nossa base de dados sem filtros aplicados:
