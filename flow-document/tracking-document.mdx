...
<Steps>
  <Step title="Criação do monitoramento" stepNumber="1">
   ...
   <Note>
    Todas os monitoramentos de novas ações processuais cadastradas como monitoramento são realizadas ***on-demand***. Recomendamos verificar as condições de custo associadas a este serviço antes de sua utilização.
   </Note>
