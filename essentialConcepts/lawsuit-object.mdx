...
1. Consulte a [documentação de endpoints](/api-reference) para ver como buscar processos
2. Verifique os [códigos de erro](essentialConcepts/errors) para tratamento adequado de exceções
