---
title: "Paginação (Offset) na Judit API"
sidebarTitle: "Paginação"
description: "Como navegar por grandes conjuntos de dados na Judit API usando paginação por offset com page e page_size, com exemplos em cURL, Python e JavaScript."
keywords: ["paginação", "pagination", "page", "page_size", "offset", "query params"]
icon: "list-ol"
---
