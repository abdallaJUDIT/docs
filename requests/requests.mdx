...
var STEPS=[
  ...
  {from:'jud',to:'crt',label:'extracao no tribunal',sub:'',col:A,ts:2.9,te:3.6},
  {from:'crt',to:'jud',label:'dados do processo',sub:'',col:J,ts:4.1,te:4.8},
  ...
  {from:'jud',to:'app',label:'response_data',sub:'com lawsuit',col:J,ts:10.8,te:11.5},
  {sep:'end'}
];
