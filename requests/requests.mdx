...
search_type: Este campo define o tipo de entidade que será buscada. Os valores possíveis são: `cpf`, `cnpj`, `oab`, `name`, `lawsuit_cnj`. Para buscas processuais, utilizaremos especificamente `lawsuit_cnj`, que corresponde ao número do processo.
