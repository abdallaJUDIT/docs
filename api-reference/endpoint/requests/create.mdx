...
<ParamField body="search" type="object" required={false}>
    <Expandable title="properties">
        ...
        <ParamField body="should_search_branches" name="should_search_branches" type="boolean" required={false}>
            Será criada uma requisição para cada filial vinculada ao CNPJ informado.
            Todas as requisições geradas serão associadas à requisição original por meio do campo `origin_id`.
        </ParamField>
