...
<RequestExample>
    ```bash Curl
    curl -X GET "https://requests.stage.judit.io/requests?page=1&pageSize=10"
    ...
    curl_setopt($ch, CURLOPT_URL, 'https://requests.stage.judit.io/requests?page=1&pageSize=10');
