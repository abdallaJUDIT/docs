...
description: "Essa página tem como objetivo mostrar o fluxo de Monitoramento de Documento."
icon: "file"
---
...
monitoramento executou, ou seja, chegou ao status updated.
  ...
  Na URL vai o request_id retornado na primeira requisição
   ...
   ```bash
   curl -X GET "https://requests.prod.judit.io/responses/?request_id={request-id-da-primeira-consulta}&page=1&page_size=10"
   -H "api_key: SUA-API-KEY"
   -H "Content-Type: application/json"
   ```
