...
<RequestExample>
    ...
    curl_setopt($ch, CURLOPT_URL, 'https://tracking.stage.judit.io/tracking?page=1&pageSize=10');
    ...
    func main() {
    const Url = "https://tracking.stage.judit.io/tracking?page=1&pageSize=10"
    ...
    url = "https://tracking.stage.judit.io/tracking?page=1&pageSize=10"
    ...
    HttpResponse<String> response = Unirest.get("https://tracking.stage.judit.io/tracking?page=1&pageSize=10)
