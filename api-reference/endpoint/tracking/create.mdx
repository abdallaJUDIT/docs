                ...
                <ParamField body="filter" type="object" required={false}>
                    <Expandable>
                        ...
                        <ParamField body="distribution_date_gte" name="distribution_date_gte" type="date" required={false}>
                          ...
                          <ParamField body="subjects" name="subjects" type="string" required={false}>
                            Este filtro é uma lista de códigos de assunto. Você pode fornecer uma lista de códigos de assunto para restringir a busca a processos que tenham esses códigos específicos.
                        </ParamField>
