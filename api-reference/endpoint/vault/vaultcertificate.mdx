...
A autenticação é feita pelo header **`api-key`**, como nas demais rotas da Judit. Esta rota **não** usa `Authorization: Bearer`.
...
Dados extras da credencial. Envie apenas quando o tribunal também exigir autenticação em dois fatores.
    <Expandable title="properties">
        ...
        Segredo 2FA (`secret` / `secrecy`) — a chave **fixa** de configuração do aplicativo autenticador, nunca o código temporário de 6 dígitos.
        </ParamField>
    </Expandable>
</ParamField>
