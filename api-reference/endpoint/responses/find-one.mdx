...
<RequestExample>
    ```bash Curl
    curl -X GET "https://requests.stage.judit.io/responses/d56e8c0a-a1de-4e75-8e4f-add06617035b"
    ...
    curl_setopt($ch, CURLOPT_URL, 'https://requests.stage.judit.io/responses/d56e8c0a-a1de-4e75-8e4f-add06617035b');
    ...
    func main() {
    const Url = "https://requests.stage.judit.io/responses/d56e8c0a-a1de-4e75-8e4f-add06617035b"
    ...
    url = "https://requests.stage.judit.io/responses/d56e8c0a-a1de-4e75-8e4f-add06617035b"
    ...
    ```java Java
    HttpResponse<String> response = Unirest.get("https://requests.stage.judit.io/responses/d56e8c0a-a1de-4e75-8e4f-add06617035b")
