...
Aqui está um exemplo da criação de uma request para execução penal por CNPJ:
...
<Note>
    Na consulta por processos (Código CNPJ), o parâmetro <strong>with_attachments</strong> Indica se a busca incluiu a captura de anexos.
</Note>
...
Segue abaixo um exemplo de resposta da consulta por CNPJ:
