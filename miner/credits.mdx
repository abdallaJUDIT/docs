...
Use `GET /requests/{request_id}` para inspecionar individualmente. Para uma visão consolidada, [Consumo](/resource/consumption/history) traz o agregado mensal de todos os produtos Judit, incluindo o Miner.
...
<CardGroup cols={2}>
  ...
  <Card title="Consumo" icon="chart-line" href="/resource/consumption/history">
