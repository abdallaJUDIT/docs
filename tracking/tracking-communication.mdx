...
<Steps>
  <Step title="Criação do monitoramento" stepNumber="1">
    ...
    <Note>
      A partir da criação do monitoramento, a Judit passará a processar as novas edições do DJEN diariamente. Apenas publicações emitidas **após a data de criação** serão monitoradas — não há retroatividade.
    </Note>
