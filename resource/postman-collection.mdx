---
title: "Postman Collection da Judit API"
sidebarTitle: "Postman"
description: "Importe a Postman Collection oficial da Judit API com todos os endpoints, exemplos de payload e variáveis de ambiente prontos para uso."
keywords: ["postman", "collection", "import", "testes", "sandbox"]
...
<Card title="Baixar judit-api.postman_collection.json" icon="download" href="/resource/judit-api.postman_collection.json">
