...
sidebarTitle: "Histórico de consumo"
description: "Como listar as requisições já realizadas na Judit API por período e inferir o custo de cada operação a partir dos campos origin, search_type, on_demand e with_attachments."
keywords: ["consumo", "histórico", "billing", "relatório", "quota", "uso", "analytics"]
