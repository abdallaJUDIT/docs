---
title: "Perguntas Frequentes (FAQ) — Judit API"
sidebarTitle: "FAQ"
description: "Respostas para as dúvidas mais comuns sobre integração, autenticação, limites e comportamento da Judit API."
keywords: ["faq", "perguntas frequentes", "dúvidas", "integração", "ajuda"]
...
Solicite sua chave por meio do [WhatsApp comercial](https://api.whatsapp.com/send/?phone=5511936186732) ou envie e-mail para `atendimento@judit.io`. Você receberá:
