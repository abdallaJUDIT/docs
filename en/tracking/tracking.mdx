...
description: "Monitor documents or lawsuits and stay up to date on all your cases"
icon: "radar"
---

JUDIT allows you to monitor lawsuits, CPFs, CNPJs, OAB or Code (CNJ), keeping you up to date on any new step.

Tracking is the automation of the lawsuit queries described in the previous section.

Every day, our API searches all courts in Brazil for lawsuits related to the CPF, CNPJ, OAB or Code (CNJ) you are tracking.
...
- `search`: Object used for the search.
    - `search_type`: In the context of lawsuit tracking, the value of this field will always be `lawsuit_cnj`.
...
```bash
curl -X PATCH "https://tracking.prod.judit.io/tracking/{tracking}" \
...
That's it! With these resources, you can stay up to date on any step in lawsuits of your interest. If you have any questions or encounter any issues, our support team is available to help. Contact us through our support portal.

_We are not responsible for queries made with invalid documents, and charges may apply due to misuse._