...
<Steps>
  <Step title="Creating the tracking" stepNumber="1">
    ...
    <Note>
      From the moment the monitoring is created, Judit will process new DJEN editions daily. Only publications issued **after the creation date** will be tracked — there is no retroactive processing.
    </Note>
