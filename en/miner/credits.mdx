...
Use `GET /requests/{request_id}` to inspect individually. For a consolidated view, [Consumption](/en/resource/consumption/history) shows the monthly aggregate across all Judit products, including Miner.
...
<CardGroup cols={2}>
  ...
  <Card title="Consumption" icon="chart-line" href="/en/resource/consumption/history">
