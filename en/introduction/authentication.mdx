...
description: "The Judit API uses API Key-based authentication passed via Header to ensure secure access to resources. Learn how to configure your key across different environments."
---
...
- **[Endpoints](/en/api-reference)**: Explore the available resources
