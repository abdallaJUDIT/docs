---
title: "Quickstart"
description: "Complete tutorial to run your first query against the Judit API"
---
## Basic Flow
...
- **[Authentication](/en/introduction/authentication)**: Configure authentication correctly
- **[Endpoints](/en/api-reference)**: Explore all available endpoints
- **[Support](https://api.whatsapp.com/send/?phone=5511920501949)**: Contact our technical support for more information.
> **Tip**: For development, use the [Postman Collection](https://drive.google.com/file/d/1PTNJjVzu65F-CGxFOXX82hwMctG1WxWU/view) with ready-to-use Judit API examples.