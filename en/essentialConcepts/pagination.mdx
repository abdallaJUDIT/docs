...
description: "The Judit API uses page-and-size (Offset) pagination to let you navigate through large data sets in a predictable and controlled way."
---
...
* 👉 **[Endpoints](/en/api-reference)**: Explore the resources that support listings.