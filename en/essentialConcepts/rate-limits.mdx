---
title: "Rate Limits"
description: "The Judit API implements rate limiting to ensure fair use of resources, prevent overload, and maintain high performance for every user."
---
...
* 👉 **[Error Handling](/en/essentialConcepts/errors):** See the complete list of errors the API can return beyond 429.
