---
title: "Penal Execution Object"
description: "The `penal_execution` object represents a Penal Execution case (sentence-serving phase). It details the progress of the sentence execution of an inmate in the courts."
---
