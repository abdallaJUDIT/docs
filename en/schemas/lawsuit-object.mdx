---
title: "Lawsuit Object"
description: "The `lawsuit` object is the central data structure that represents a complete judicial lawsuit in the Judit API. It contains everything from the lawsuit header to case updates and attachments."
---
