---
title: "Warrant Object (Arrest Warrant)"
description: "The `warrant` object represents an arrest or recapture order extracted from the National Database of Arrest Warrants (BNMP) and the courts. It contains the order data, the sentence, and the wanted individual."
---
