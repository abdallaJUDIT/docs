...
description: "Structure of the Communication object returned by the National Electronic Justice Gazette (DJEN) monitoring in the Judit API. Includes publication metadata, recipients, linked lawyers and full publication text."
keywords: ["communication", "official gazette", "DJEN", "intimation", "publication", "schema", "monitoring"]
icon: "newspaper"
---
...
* 👉 **[Official Gazette Monitoring](/en/tracking/tracking-communication):** See how to set up DJEN monitoring and receive publications via webhook.
