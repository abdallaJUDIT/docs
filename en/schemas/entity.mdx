---
title: "Entity object (Registration data)"
description: "The `entity` object is the data structure returned by CPF (natural person) and CNPJ (legal entity) queries. It consolidates registration information, contact data, addresses, and relationships."
---
...
* 👉 **[Registration data queries](/en/requests/cadastral):** See the documentation for the request route to fetch and enrich CPFs and CNPJs in real time.