...
Some courts require **two things at once**: the digital certificate **and** the 2FA secret (also called `secret`, `secrecy`, secret key, manual key or authenticator setup key).
