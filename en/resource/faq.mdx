...
Yes. Two objects will be returned, one for each instance, within the same array. The first object, at position zero, will represent the most recent instance.
