...
sidebarTitle: "Consumption history"
description: "How to list the requests already made on the Judit API by period and infer the cost of each operation from the origin, search_type, on_demand and with_attachments fields."
keywords: ["consumption", "history", "billing", "report", "quota", "usage"]
