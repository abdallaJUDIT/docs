---
title: "Consumption — Judit API"
sidebarTitle: "Consumption"
description: "How to monitor and estimate Judit API consumption by request, with practical examples to extract usage reports per period."
keywords: ["consumption", "billing", "report", "quota", "usage"]
icon: "chart-pie"
---
