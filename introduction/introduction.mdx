...
var FLOWS=[
  {id:'async',title:'① Requests — Assíncrono',sub:'Extração em tempo real direto no tribunal',col:A,ts:1,te:13,act:['app','judit','court'],steps:[
    {fr:'app',to:'judit',label:'POST /requests',note:'{search_type, search_key}',col:A,ts:1.5,te:2.3,yp:0.32},
    {fr:'judit',to:'court',label:'extração tribunal',note:'em tempo real',col:T,ts:3.2,te:4.0,yp:0.48},
    {fr:'court',to:'judit',label:'dados do processo',note:'',col:J,ts:4.9,te:5.7,yp:0.62},
    {fr:'judit',to:'app',label:'webhook / polling',note:'response_data',col:J,ts:6.6,te:7.4,yp:0.78}]},
  {id:'track',title:'② Tracking — Monitoramento',sub:'Verifica o tribunal periodicamente e notifica por webhook',col:'#F6AD55',ts:14,te:27,act:['app','judit','court'],steps:[
    {fr:'app',to:'judit',label:'POST /tracking',note:'{search_type, search_key}',col:A,ts:14.5,te:15.3,yp:0.32},
    {fr:'judit',to:'court',label:'verifica periodicamente',note:'recorrência configurável',col:T,ts:16.2,te:17.0,yp:0.48},
    {fr:'court',to:'judit',label:'nova movimentação',note:'',col:J,ts:17.9,te:18.7,yp:0.62},
    {fr:'judit',to:'app',label:'webhook',note:'event: new_step',col:'#F6AD55',ts:19.6,te:20.4,yp:0.78}]},
  {id:'sync',title:'③ Lawsuits — Síncrono (Hot Storage)',sub:'Lê o datalake JUDIT — não vai ao tribunal',col:D,ts:28,te:41,act:['app','judit','dl'],steps:[
    {fr:'app',to:'judit',label:'POST /lawsuits',note:'{search_type, search_key}',col:A,ts:28.5,te:29.3,yp:0.32},
    {fr:'judit',to:'dl',label:'leitura datalake',note:'sem consultar o tribunal',col:D,ts:30.2,te:31.0,yp:0.48},
    {fr:'dl',to:'judit',label:'processos indexados',note:'em milissegundos',col:D,ts:31.9,te:32.7,yp:0.62},
    {fr:'judit',to:'app',label:'200 {response_data}',note:'mesma requisição — síncrono',col:J,ts:33.6,te:34.4,yp:0.78}]}
];
