...
- API Key válida [(solicite acesso conosco)](https://api.whatsapp.com/send/?phone=55219852841438865)
...
Esse campo define por quantos dias um resultado armazenado em cache será considerado válido antes de uma nova consulta ser feita.
```json
{
...
- **[Suporte](https://api.whatsapp.com/send/?phone=55219852841438865)**: Entre em contato com nosso suporte técnico para mais informações.
