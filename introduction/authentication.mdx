---
title: "Autenticação"
description: "A Judit API usa autenticação baseada em **API Key** para garantir acesso seguro aos recursos. Este guia explica como obter, configurar e usar sua chave de API corretamente."
---
...
> **Suporte**: Em caso de problemas com autenticação, entre em contato com nosso [suporte técnico](https://api.whatsapp.com/send/?phone=5521995265795).
