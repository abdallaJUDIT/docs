---
title: "Schema Entity (Dados Cadastrais)"
sidebarTitle: "Entity"
description: "Estrutura do objeto Entity retornado pela consulta de dados cadastrais por CPF (Pessoa Física) ou CNPJ (Pessoa Jurídica). Inclui contatos, endereços, sócios e vínculos."
keywords: ["entity", "dados cadastrais", "cpf", "cnpj", "pessoa física", "pessoa jurídica", "sócios", "vínculos"]
icon: "id-card"
---
