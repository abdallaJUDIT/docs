---
title: "Schema Warrant (Mandado de Prisão)"
sidebarTitle: "Warrant"
description: "Estrutura do objeto Warrant retornado pela consulta de mandados de prisão na Judit API. Inclui dados da ordem, pena, leis infringidas e do indivíduo procurado."
keywords: ["warrant", "mandado de prisão", "BNMP", "schema", "execution", "procurado"]
icon: "handcuffs"
---
