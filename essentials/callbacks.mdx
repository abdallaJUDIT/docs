...
⚠️ Em alguns casos, o campo cached_response pode estar como false e ainda assim ser a única resposta enviada. Isso acontece quando a consulta processual foi feita recentemente, tornando desnecessária uma nova captura no tribunal.
</Note>
