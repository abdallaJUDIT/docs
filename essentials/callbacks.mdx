...
Se voce realizar uma busca com o `search_params` objeto passando como parâmetro o campo `masked_response` sendo true, o campo `response_data` ou `page_data`, vai retornar um objeto com as informações minificadas com o formato parecido com o seguinte:
