...
Fazemos uma solicitação POST para webhooks com a resposta de acordo com sua busca.
...
Se voce realizar uma consulta processual com o campo `search_type` passando como valor **"lawsuit_cnj"**', o campo `response_data` retornará a resposta com o formato parecido com o seguinte:
...
Uma busca com o campo `search_type` sendo passado como valor **"cpf"**, **"cnpj"**,**"oab"**,**"steps"**,**"attachments"** ou **"parties"**, o campo `response_data` irá gerar as respostas de forma paginada, onde `page_data` será um array que poderá conter no máximo 50 itens e também pode variar seu tipo de acordo com o `search_type` informado.
Caso informado **"cpf"**, **"cnpj"**,**"oab"**, o retorno sempre será um array de lawsuit.
...
Uma busca com o `search_type` passando como valor **"steps"**:
...
Uma busca com o `search_type` passando como valor **"attachments"**:
