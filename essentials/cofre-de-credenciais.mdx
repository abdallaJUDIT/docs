...
> 🤖 Endpoint base: `https://crawler.prod.judit.io/credentials`. Cadastre uma vez por sistema/tribunal e referencie depois nas consultas via `credential.customer_key`.
...
Alguns tribunais exigem **duas coisas ao mesmo tempo**: o certificado digital **e** o segredo 2FA — enviado no campo `secret`, e chamado no portal do tribunal de chave secreta, chave manual ou chave de configuração do autenticador.
