...
`Obs:` - Para OAB usar o seguinte padrão: UF + 0 + **numerodaOAB**
...
## Aqui está o exemplo do retorno da criação da sua request
...
```bash
curl -X GET "https://requests.prod.judit.io/requests/responses?request_id=1e6cd05b-c91a-4c14-b445-2ca96dd8a6fa"
-H "api-key: YOUR_API_KEY"
```
