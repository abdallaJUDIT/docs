...
Esta API permite que partes interessadas verifiquem apenas mandados com o response_type como warrant, garantindo a precisão e a relevância das informações consultadas.
