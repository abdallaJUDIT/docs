...
# Exemplo de request de criação de um mandado de prisão

Aqui está um exemplo da criação de uma request de mandado de prisão por CPF:
...
# Retorno da criação de um mandado de prisão
