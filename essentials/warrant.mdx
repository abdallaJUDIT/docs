...
Esta API permite que autoridades e partes interessadas verifiquem apenas mandados com o search_type como warrant, garantindo a precisão e a relevância das informações consultadas.
