...
O retorno é paginado e contém o [Objeto Lawsuit](/pt/schemas/lawsuit-object) dentro do array `page_data`. Se você solicitou a **Judit IA**, o resumo virá como um objeto adicional dentro dessa mesma lista.
