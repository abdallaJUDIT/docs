...
Para consultas mais específicas por <strong>documento</strong>, é possivel utilizar [filtros](/pt/requests/request-document#payload-da-solicitação):
...
- **[Autenticação](/pt/introduction/authentication)**: Configure a autenticação adequada
- **[Endpoints](/pt/api-reference)**: Explore todos os endpoints disponíveis
