...
* 👉 **[Rate Limits](/pt/essentialConcepts/rate-limits):** Veja como construir a função de *Retry com Exponential Backoff* para tratar erros `429`.
* 👉 **[Autenticação](/pt/authentication):** Revise como enviar suas credenciais corretamente para evitar erros `401`.
* 👉 **[FAQ](/pt/resource/faq):** Veja as respostas para os problemas de integração mais comuns.