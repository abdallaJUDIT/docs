...
* 👉 **[Consultas Penais](/pt/requests/penal):** Veja a documentação do endpoint para iniciar uma extração em varas criminais e de execução.
* 👉 **[Objeto Dados Cadastrais](/pt/schemas/entity):** Veja como interpretar o modelo de dados de dados cadastrais.