...
* 👉 **[Consultas Penais](/pt/requests/penal):** Veja a documentação do endpoint específico para disparar buscas por mandados de prisão.
* 👉 **[Objeto Entity](/pt/schemas/entity):** Revise todas as propriedades possíveis do objeto `entity` retornado dentro do mandado.